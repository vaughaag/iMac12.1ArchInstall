...
You can now work through the options. I would suggest selecting world wide within the mirror list for now. This can be changed later once Arch is installed.
